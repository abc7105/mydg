...
begin
  ...
  // adg := auditdg.create(ADGSYSTEM.connection, ExcelApp.Application, mainpath);
  ...
  begin
    ...
    adxRibbonTab1.Controls[0].AsRibbonGroup.controls[4].AsRibbonMenu.Visible :=
      false;
    adxRibbonTab1.Controls[0].AsRibbonGroup.controls[5].AsRibbonMenu.Visible :=
      true;
...
begin
  //
  ShellExecute(0, 'open', PChar(mainpath + '底稿生成视频.exe'), nil, nil, 1);
end;
...
begin
  ...
  if not sheetexists(ExcelApp.Application, '科目表样9列') then
  begin
  ...
  try
    ...
    case Application.MessageBox(PChar('您确认将数据导入账套 [' + axm.xmid + ' '
      + axm.xmname + ']，您继续吗？'),
...
begin
  //打开初始模板
  try
    excelapp.Workbooks.Open(mainpath + '底稿基本信息.xls'
...
begin
  ...
  if not sheetexists(ExcelApp.Application, '科目表样7列') then
  begin
...
begin
  ...
  ExcelApp.ActiveWindow.SelectedSheets.PrintOut(EmptyParam, EmptyParam,
    EmptyParam, false,
...
begin
  begin
    ExcelApp.Workbooks.Open(mainpath + '银行函证.xlsx', EmptyParam,
...
procedure TAddInModule.adxRibbonTab1Controls0Controls6Controls2Click(
  Sender: TObject; const RibbonControl: IRibbonControl);
begin
  ExcelApp.Workbooks.Open(mainpath + '往来询证函.xlsx', EmptyParam,
    EmptyParam, EmptyParam, EmptyParam,
    EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam,
    EmptyParam, EmptyParam, EmptyParam, adxLCID
    );
...
procedure TAddInModule.adxRibbonTab1Controls0Controls6Controls4Click(
  Sender: TObject; const RibbonControl: IRibbonControl);
begin
  ExcelApp.Workbooks.Open(mainpath + '信件封面.xls', EmptyParam,
    EmptyParam, EmptyParam, EmptyParam,
    EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam,
    EmptyParam, EmptyParam, EmptyParam, adxLCID
    );
...
begin
  //
  ShellExecute(Application.Handle, 'Open', PChar(mainpath +
    '科目余额表生成底稿演示视频.exe'),
    '', '', SW_SHOWNORMAL); //Application.Handle
...
begin
  ...
  if not sheetexists(ExcelApp.Application, '凭证表') then
  begin
...
begin
  ...
  ShellExecute(0, 'open', PChar(mainpath + 'sjprog.exe'), nil, nil, 1);
...
begin
  //打开初始模板
  try
    excelapp.Workbooks.Open(mainpath + '科目余额表模板.xls'
      , EmptyParam, EmptyParam, EmptyParam, EmptyParam,
      EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam,
      EmptyParam, EmptyParam, EmptyParam, adxLCID
      );
...
begin
  ...
  try
    excelapp.Workbooks.Open(mainpath + '凭证导入模板.xls'
      , EmptyParam, EmptyParam, EmptyParam, EmptyParam,
      EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam,
      EmptyParam, EmptyParam, EmptyParam, adxLCID
      );
...
procedure TAddInModule.adxRibbonTab1Controls2Controls2Controls3Click(
  Sender: TObject; const RibbonControl: IRibbonControl);
begin
  ExcelApp.Workbooks.Open(mainpath + '交易询证函.xls', EmptyParam,
    EmptyParam, EmptyParam, EmptyParam,
    EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam,
    EmptyParam, EmptyParam, EmptyParam, adxLCID
    );
