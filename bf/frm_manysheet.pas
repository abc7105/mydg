...
begin
  ...
  xlsapp.ActiveWindow.SelectedSheets.PrintOut(EmptyParam, EmptyParam, EmptyParam, false,
    ...
    if CheckListBox1.Checked[i - 1] then
      ...
      begin
        try
          ...
          //  excelrange(xlsapp.ActiveWindow.Selection).Copy(EmptyParam);
          ROWS := asheet.UsedRange[adxLCID].ROWS.ITEM[asheet.UsedRange[adxLCID].ROWS.Count, EmptyParam].Row;
          COLS := asheet.UsedRange[adxLCID].Columns.ITEM[asheet.UsedRange[adxLCID].Columns.Count, EmptyParam].Column;
