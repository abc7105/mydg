...
// PASTLWTR : 1.2
// File generated on 2012-3-17 15:56:36 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\_delphi60prog\lxydgs\lxydg.tlb (1)
// LIBID: {4E2B9699-44EE-417B-B182-8C247AA88F93}
// LCID: 0
// Helpfile: 
// HelpString: lxydg Library
// DepndLst: 
...
const
  ...
  LIBID_lxydg: TGUID = '{4E2B9699-44EE-417B-B182-8C247AA88F93}';

  IID_Ilxydgs: TGUID = '{BA473636-6A76-4843-94DD-F0AF12C1BD46}';
  CLASS_lxydgs: TGUID = '{F2533A37-863E-4696-B3FD-76D8CC6796DB}';
  IID_Idg: TGUID = '{6D126102-A5EB-47A3-BA61-40BD2B84CFCB}';
  DIID_IdgEvents: TGUID = '{9DD7D262-2B4C-4639-A450-E8F1ADD2E07F}';
  CLASS_dg: TGUID = '{BCB55D04-1860-4098-ADF2-725F1D2933D7}';
...
// GUID:      {BA473636-6A76-4843-94DD-F0AF12C1BD46}
// *********************************************************************//
  Ilxydgs = interface(IDispatch)
    ['{BA473636-6A76-4843-94DD-F0AF12C1BD46}']
  end;

// *********************************************************************//
// DispIntf:  IlxydgsDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {BA473636-6A76-4843-94DD-F0AF12C1BD46}
// *********************************************************************//
  IlxydgsDisp = dispinterface
...
// Interface: Idg
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {6D126102-A5EB-47A3-BA61-40BD2B84CFCB}
// *********************************************************************//
  Idg = interface(IDispatch)
    ['{6D126102-A5EB-47A3-BA61-40BD2B84CFCB}']
...
// GUID:      {9DD7D262-2B4C-4639-A450-E8F1ADD2E07F}
// *********************************************************************//
  IdgEvents = dispinterface
    ['{9DD7D262-2B4C-4639-A450-E8F1ADD2E07F}']
...
// *********************************************************************//
// The Class Colxydgs provides a Create and CreateRemote method to          
// create instances of the default interface Ilxydgs exposed by              
// the CoClass lxydgs. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  Colxydgs = class
    class function Create: Ilxydgs;
    class function CreateRemote(const MachineName: string): Ilxydgs;
  end;
...
class function Colxydgs.Create: Ilxydgs;
begin
  Result := CreateComObject(CLASS_lxydgs) as Ilxydgs;
end;

class function Colxydgs.CreateRemote(const MachineName: string): Ilxydgs;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_lxydgs) as Ilxydgs;
end;
...
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{BCB55D04-1860-4098-ADF2-725F1D2933D7}';
    EventIID: '{9DD7D262-2B4C-4639-A450-E8F1ADD2E07F}';
    EventCount: 8;
