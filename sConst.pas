...
var
  ...
  ac_ChangeThumbPreviews : boolean = False; // True;  // Allow a changing of Aero preview window by AlphaControls (is not ready at moment)
...
initialization
  EmptyCI.Ready := False; EmptyCI.X := -99; EmptyCI.X := -99; EmptyCI.Bmp := nil; EmptyCI.FillColor := clFuchsia;
  sFuchsia.C := $FF00FF;
